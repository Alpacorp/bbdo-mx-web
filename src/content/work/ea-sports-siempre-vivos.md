---
titulo: 'EA Sports – Siempre vivos'
marca: 'EA Sports'
campana: 'Siempre vivos'
cliente: 'EA Sports'
...
descripcion: 'EA Sports celebró que en la cancha digital nadie se retira del todo. Siempre vivos jugó con la idea de que los ídolos siguen compitiendo mientras alguien tome el control.'

imagen: '../../assets/work/ea-sports-siempre-vivos.jpg'
imagenAlt: 'Fotograma de la campaña EA SPORTS - SIEMPRE VIVOS'
...
slugAnterior: '/portfolio/ea-sports-siempre-vivos/'
orden: 5
destacado: true
borrador: false
---
...
<!-- Cuerpo del caso: pendiente de curaduría y de que lo firme el director
     creativo. Aquí va el reto, la idea y el resultado, con cifras si las hay. -->
